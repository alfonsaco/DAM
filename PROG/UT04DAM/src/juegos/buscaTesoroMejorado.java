...
public class buscaTesoroMejorado {
        ...
        while (intentos<5 && !encontrado && !tocadoMina) {
            ...
            if (filaUsuario>=0 && filaUsuario<filas && columnaUsuario>=0 && columnaUsuario<columnas) {
                ...
                if (filaUsuario==filaMina && columnaUsuario==columnaMina) {
                    ...
                    if (estaCercaDeMina(filaUsuario, columnaUsuario,filaMina,columnaMina))
    ...
    private static boolean estaCercaDeMina(int filaUsuario, int columnaUsuario, int filaMina, int columnaMina) {
        return Math.abs(filaUsuario-filaMina)<=1 && Math.abs(columnaUsuario-columnaMina)<= 1;
    }
}