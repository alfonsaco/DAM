...
public class Participa {
	...
	public String toString() {
		return "Participa [codparticipacion=" + codparticipacion + ", estudiante=" + estudiante + ", proyecto="
				+ proyecto + ", tipoparticipacion=" + tipoparticipacion + ", numaportaciones=" + numaportaciones + "]";
	}
