...
DROP TABLE T_LINEAS CASCADE CONSTRAINTS;
create table  T_LINEAS(
 cod_linea      NUMBER(5) primary key,
...
DROP TABLE T_ESTACIONES CASCADE CONSTRAINTS;
create table  T_estaciones(
 cod_estacion    NUMBER(5) primary key,
 nombre           varchar(50) not null,
...
DROP TABLE T_LINEA_ESTACION CASCADE CONSTRAINTS;
create table  T_linea_estacion(
 cod_linea     NUMBER(5)  not null,
 cod_estacion  NUMBER(5)  not null,
...
DROP TABLE T_ACCESOS CASCADE CONSTRAINTS;
create table  T_accesos(
 cod_acceso     NUMBER(5)  primary key,
...
DROP TABLE T_COCHERAS CASCADE CONSTRAINTS;
create table  T_cocheras(
 cod_cochera    NUMBER(5) primary key,
 nombre         varchar(50) not null,
 direccion      varchar(50) not null
 ) ;
...
DROP TABLE T_TRENES CASCADE CONSTRAINTS;
create table  T_trenes(
 cod_tren    NUMBER(5) primary key,
 nombre      varchar(50) not null,
 tipo       varchar(20) not null,
 cod_linea     NUMBER(5) not null,
 cod_cochera   NUMBER(5)  not null,
 FOREIGN KEY (cod_linea)    REFERENCES   T_LINEAS(cod_linea),
