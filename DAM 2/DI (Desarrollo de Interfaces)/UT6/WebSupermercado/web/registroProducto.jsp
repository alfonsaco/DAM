<%-- 
    Document   : registrosProductos
    Created on : 20-ene-2025, 10:52:29
    Author     : Alfonso
--%>
                                    ...
                                    <div>
                                        <form action = "ProductoControl" method = "post" class="form-horizontal">
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="cantidad_inventario" value="" placeholder="Cantidad de inventario del producto"/> 
                                                </div>
                                            </div>
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="precio" value="" placeholder="Precio del producto"/> 
                                                </div>
                                            </div>
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="proveedor">
                                                        ...
                                                        <% for (Proveedor prov : ProveedorDao.listar()) {%>
                                                        <option value="<%=prov.getNit()%>"><%=prov.getNombre()%></option>
                                                        <%}%>
                                                    </select>
                                                </div>
                                            </div>
